...
def signup():
    ...
    try:
        if request.method == 'POST' and form.validate_on_submit():
            ...
            db.session.add(user)
            db.session.commit()
            flash(f'Than you for joining us! {first_name} {last_name}', 'User-created')
    ...
    try:
        if request.method == 'POST' and form.validate_on_submit():
            ...
            if logged_user and check_password_hash(logged_user.password, password):
                ...
                flash('You were successful in your initiation. Congratulations, and welcome to Ben Enterprises', 'auth-success')
